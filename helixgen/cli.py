...
# directory, so an installed helixgen works from anywhere. The matching --dataset,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="Path to a model catalog (default: the one bundled with helixgen)",
    )
    parser.add_argument(
        "--version",
        action="version",
        version=f"helixgen {__version__}",
    ...
    describe_parser.add_argument(
        ...
        help=(
            ...
            "(defaults to the copy bundled with helixgen)"
        ),
    )
    describe_parser.add_argument(
        "--upload-mode",
