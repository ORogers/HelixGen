...
# Defaults shared by the CLI (`helixgen describe`) and the desktop UI (helixgen_ui), so
...
def openai_api_key() -> str | None:
    ...
    """
    from helixgen.config import read_setting
...
def store_openai_api_key(key: str | None) -> None:
    ...
    from helixgen.config import write_setting
