...
class BlockEditor:
    """Drives surgical edits over an open :class:`~hlxgen.device.usb.Session`."""
...
def plan_chain(
    ...
    *,
    ...
    """
    from hlxgen.device.codec import _resolve_symbol, tone_blocks
...
def apply_tone(
    ...
    *,
    ...
    report = EditReport()
    preset_name = name or preset.get("data", {}).get("meta", {}).get("name") or "hlxgen"
