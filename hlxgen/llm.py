...
def _compose_parameter_prompt(
    ...
    instructions = (
        ...
        "Don't set the gain or drive on distortion pedals, compressors very high. distortion pedals will be used in "
        "conjunction with amps to get a high gain sound."
        "The gain/drive of amps should be at least 0.4, and at most 0.75."
