...
- [guide.md](guide.md) - install, describe a tone, get it onto your pedal.
  Start here.
...
- [legal.md](legal.md) - trademarks, how the device support was built, and
  which data files are and are not distributed.
