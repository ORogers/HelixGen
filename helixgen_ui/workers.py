...
from helixgen.validator import ValidationError
...
class GenerationWorker(_Worker):
    """Runs :func:`helixgen_ui.generation.generate_tone` off the UI thread."""
...
class UsbUploadWorker(_Worker):
    ...
    Same path as ``helixgen push``: surgical edits via ``apply_tone``.
    """
