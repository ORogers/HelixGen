...
Thin wrapper over ``helixgen.cli._upload_via_script`` - the only working upload
mechanism today (AppleScript-driven HX Edit automation, macOS only; see
``docs/application_flow.md`` §5 and ``docs/usb_protocol.md`` for why). No
...
from helixgen.cli import DEFAULT_UPLOAD_SCRIPT
from helixgen.cli import _upload_via_script as upload_via_script
