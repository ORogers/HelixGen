...
HelixPy cannot generate anything without a backend behind it, and the better
...
from hlxgen.llm import store_openai_api_key
...
_INTRO = (
    "HelixPy turns a description of a tone into a preset. Something has to do "
...
class SetupPage(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        title = QLabel("Welcome to HelixPy")
